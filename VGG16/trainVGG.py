...
envarg.add_argument("--resnet_model", default="resnet_v2_50", choices=["vgg_16", "resnet_v2_50", "resnet_v2_101", "resnet_v2_152", "resnet_v2_200"], help="Resnet model to use as feature extractor. Choose one of: resnet_v2_50 or resnet_v2_101")
...
validation_dataset = validation_dataset.shuffle(buffer_size=10)
...
logits_tf = tf.cond(is_training_tf, true_fn= lambda: networkVGG.deeplab_v3(batch_images_tf, args, is_training=True,reuse=tf.AUTO_REUSE),false_fn=lambda: networkVGG.deeplab_v3(batch_images_tf, args, is_training=False,reuse=True))
